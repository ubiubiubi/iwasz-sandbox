...
extern uint32_t  USBD_HID_AltSet;
extern uint32_t  USBD_HID_Protocol;
extern uint32_t  USBD_HID_IdleState;
...
extern void buildReport (uint8_t modifier, uint8_t key);
